...
public class UpdateListInfoAction extends BaseAction {
	...
	public String execute() {
		ObjectAdapter adapter = new ObjectAdapter(ResourceTypeConst.TYPE_LIST, name, delhtml(description), getSessionUID(), getImgSrc(description), "");
		adapter.setId(id);
	...
	private List<Integer> updatePermission() {
		...
		List<Integer> list = PermissionFactory.getListPermissionManager().findWriteTeams(id);
