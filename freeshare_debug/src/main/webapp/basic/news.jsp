...
<body>
	<div id="container">
		...
		<div id="inner" class="content dottedline">
			...
			<div class="main leftmargin_0">
				...
				<div>
					<a class="graybutton" href="getmygroups" rel="facebox" title="选择群组动态">选择群组动态</a>
					<a class="graybutton leftbutton" id="allnews" href="javascript:void(0)">全部</a> 
					<a class="graybutton middlebutton" id="easynews" href="javascript:void(0)">话题</a>
	...
	<script src="js/basic/init_toolbar.js"></script>
</body>