...
var recItemFunc = function(data) {
	...
	$.each(results, function(i,value){
		...
		$('#reco_you').append("<div class= \"leftmargin_10 dottedline topmargin_5 padding5 bottommargin_5 greybg\" "
				+ "id=\"reco" + resourceId + "\" >"
				+ "<table><tr><td><a class = \"greyletter\" href=\""
				+ url
				+ "\">"
				+ name
...
var recItemFunc1 = function(data) {
	...
	$.each(results, function(i,value){
		...
		$('#reco_you1').append("<div class= \"leftmargin_10 topmargin_5 bottommargin_5\">"
				+ "<a class = \"greyletter\" href=\""
				+ url
				+ "\">"
				+ name
				+ "</a>"
...
var recGroupFunc = function(data) {
	...
	$.each(	results, function(i,value){
		...
		//alert("url:"+url);
		//alert("groupId:"+url.substring(url.indexOf("=")+1));
