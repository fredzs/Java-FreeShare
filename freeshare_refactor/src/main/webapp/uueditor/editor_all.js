...
var dtd = dom.dtd = (function() {
    ...
    return  _({
        ...
        //在table元素里的元素列表
        $tableContent : _({caption:1,col:1,colgroup:1,tbody:1,td:1,tfoot:1,th:1,thead:1,tr:1,table:1,border:1}),
        //不转换的标签
 ...
 */
    UE.plugins['autofloat'] = function() {
        ...
        function updateFloating(){
        	...
        	if (rect3.top < 66 && rect3.bottom - toolbarBox.offsetHeight > 0) {
                setFloating();
            }else{
                unsetFloating();
            }
        ...
        me.addListener('beforepaste', function (cmd, html) {
            ...
            if (tableCopyList) {
                ...
                if (td) {
                    ...
                    me.execCommand('insertHTML', '<table border=\'2px\' ' +
