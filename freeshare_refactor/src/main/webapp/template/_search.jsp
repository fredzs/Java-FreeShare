...
<form action="search" id="search" method="post" target="_blank">
	<input type="text" class="squareinputmid greyletter rightmargin_10" 
					id="squery" placeholder="搜索各类资源、列表和群组" />
		...
		<div class="padding5 bottommargin_5">
			...
			<div id="searchmytypes" class="greybox padding5 radius">
				<div class="bottommargin_5">
					...
					<label for="selectalltypes">全部资源</label>
				</div>
				<div class="searchmytypes">
					<input type="checkbox" id="SHARE:RESOURCE:LIST:1" value="SHARE:RESOURCE:LIST" checked="checked" name="types"/> 
					<label class="rightmargin_20" for="SHARE:RESOURCE:LIST:1">列表</label>
					<input type="checkbox" id="SHARE:RESOURCE:TEXT:1" value="SHARE:RESOURCE:TEXT" checked="checked"  name="types"/> 
					<label class="rightmargin_20" for="SHARE:RESOURCE:TEXT:1">文章</label>
					<input type="checkbox" id="SHARE:RESOURCE:URL:1" value="SHARE:RESOURCE:URL" checked="checked"  name="types"/> 
					<label class="rightmargin_20" for="SHARE:RESOURCE:URL:1">链接</label>
					<input type="checkbox" id="SHARE:RESOURCE:VIDEO:1" value="SHARE:RESOURCE:VIDEO" checked="checked" name="types" /> 
					<label class="rightmargin_20" for="SHARE:RESOURCE:VIDEO:1">视频</label>
					<input type="checkbox" id="SHARE:RESOURCE:DOC:1" value="SHARE:RESOURCE:DOC" checked="checked" name="types" /> 
					<label class="rightmargin_20" for="SHARE:RESOURCE:DOC:1">文档</label>
					<input type="checkbox" id="SHARE:RESOURCE:TOPIC:1" value="SHARE:RESOURCE:TOPIC" checked="checked" name="types" /> 
					<label class="rightmargin_20" for="SHARE:RESOURCE:TOPIC:1">话题</label>
					<input type="checkbox" id="SHARE:FMT:GROUP:1" value="SHARE:FMT:GROUP" checked="checked" name="types" /> 
