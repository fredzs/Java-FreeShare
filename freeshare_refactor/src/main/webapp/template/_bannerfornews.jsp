...
<div class="banner">
	<div class="content">
		...
		<span class="nav">
	        ...
	        <a href="groups" class="nodecoration" target="_blank">
	        ...
	        <a href="javascript:void(0)" class="nodecoration webwidget_vertical_menu"> 
				...
				<ul class="webwidget_vertical_menu_content tightline">
					<li class="padding5 toppadding_0 bottompadding_0">
						<a href="collections" target="_blank"><img src="images/bn_mine_1.png" border="0" /></a>
					</li>
					<li class="padding5 toppadding_0 bottompadding_0">
						<a href="resources" target="_blank"><img src="images/bn_mine_3.png" border="0" /></a>
					</li>
				</ul>
			</span>
	    	...
	    	<a href="javascript:void(0)" 
	    		...
	    		<ul class="webwidget_vertical_menu_content tightline">
					<li class="padding5 toppadding_0 bottompadding_0">
						<a href="upload/uploaditem" target="_blank"><img src="images/bn_new_1.png" border="0" /></a>
					</li>
					<li class="padding5 toppadding_0 bottompadding_0">
						<a href="upload/uploadlist" target="_blank"><img src="images/bn_new_2.png" border="0" /></a>
					</li>
					<li class="padding5 toppadding_0 bottompadding_0">
						<a href="upload/uploadtopic" target="_blank"><img src="images/bn_new_3.png" border="0" /></a>
					</li>
				</ul>
			</span>
			<span>
