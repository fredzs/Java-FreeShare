 ...
 <div id="container">
  ...
  <div id="inner" class="content">
  	<div class="topmargin_20">
		...
		<div class="leftmargin_20 bottommargin_5 bottomveralign"><span class="blueletter">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="backgroup" onclick="backToGroup();">群组页</a>》<s:property value="name"/></span>
						...
						<table >
							...
							<td class="middleveralign" width="20px">
				       			<s:if test="kind <2&&#st.index != 0&&type==2">
				        			<input type="checkbox" value="<s:property value="#c.uid"/>" name="<s:property value ="#c.userId"/>"/>
				        		</s:if>
				       	    <s:else>
				       	    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				       	    </s:else>
				     	    ...
				     	    <td width="60px">
				     		 	...
				     		 	<td >
				       			...
				       			<s:if test="#st.index != 0&&type==2">
				       				...
				       				<span class="rightfloat"><a class="blackletter" href="javascript:groupManager.setOrRemoveAdmin(<s:property value="#c.uid"/>,'cancle')">取消管理员</a></span>
				       			</s:if>
				       			<br/>
				...
				<tr>
					<td class="middleveralign" width="20px">
	       			<s:if test="kind <2&&type==2">
	        			<input type="checkbox" value="<s:property value="#al.uid"/>" name="<s:property value ="#al.email"/>"/>
	        		</s:if>
		       	    <s:else>
		       	    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		       	    </s:else>
	    	    	...
	    	    	<td width="60px">
	     		 	...
	     		 	<td >
	       			...
	       			<s:if test="type==2">
	       				<span class="rightfloat"><a class="blackletter" href="javascript:groupManager.setOrRemoveAdmin(<s:property value="#al.uid"/>,'cancle')">取消管理员</a></span>
	    ...
	    <s:if test="kind==1">
	      ...
	      <div>
				<table >
					...
					<td class="middleveralign" width="20px">
		       			<s:if test="kind <2">
		        			<input type="checkbox" value="<s:property value="#ul.uid"/>" name="<s:property value ="#ul.email"/>"/>
		        		</s:if>
		        	</td>
	    ...
	    <s:else>
	      ...
	      <div>
	        ...
	        <td >
         		<s:property value="#ul.screen_name"/> 
         		<s:if test="type==2">
         			<span class="rightfloat "><a class="blackletter" href="javascript:groupManager.setOrRemoveAdmin(<s:property value="#ul.uid"/>,'agree');">设为管理员</a></span>         			
         		</s:if>
