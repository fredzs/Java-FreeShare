...
<div id="container">
	...
	<div class="banner" style="position: fixed; top: 25px; right: 0px; left: 0px; z-index: 999;">
    	...
    	<span class="nav">
        	...
        	<a href="basic/logAdmin.jsp"><img src="images/banner_day.png" border="0" class="cur"></a>
    	</span>
	</div>
	...
	<div id="inner" style="padding-top: 65px;">
		...
		<div class="left">
			 <dl>
				<dt class="selected">
					<a href="basic/logAdmin.jsp"><img src="images/left_log.png" border="0"></a>
				</dt>
				<dt class="">
					<a href="basic/logAdmin.jsp"><img src="images/left_user_active.png" border="0"></a>
				</dt>
				<dt class="">
					<a href="basic/logAdmin.jsp"><img src="images/left_resource_active.png" border="0"></a>
				</dt>
			</dl> 
		</div>
