		...
		<form id="updateGroup" name="newgroup" action="group/updategroupinfo">
			...
			<tr>
				<td class="topveralign">
					用户密码<span class="redletter">*</span> <br />
					<span class="lightgreyletter">数字和字母的组合</span>
				</td>
				<td>
				 	<textarea id="pwd" cols="30" rows="1" class="fullarea blue1border"
						name="pwd" ></textarea> 
			...
			<tr>
				...
				<td>	
						...
						<s:iterator id="doc" value="groupList" status="st">
							<option value="<s:property value="#doc.groupId"/>"><s:property value="#doc.groupInfo.name" /></option>
						</s:iterator>
						</select>
