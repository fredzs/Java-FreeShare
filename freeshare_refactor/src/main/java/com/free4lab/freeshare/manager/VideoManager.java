...
public class VideoManager {
	private static final String PIC = "http://freedisk.free4lab.com/download?uuid=172c7251-55ba-4805-97a5-97f6e07e6063";
	/*
	 * 优酷获取
	 */
	...
	public String getFlash(String url) {
		...
		try {
			...
			System.err.println("get flash error : " + url);
			return "";
		}
		return v.getFlash();
	}
	...
	public String getImgsrc(String url) {
		...
		try {
			...
			System.err.println("get img error : " + url);
			return "";
		}
		return v.getPic();
	}
