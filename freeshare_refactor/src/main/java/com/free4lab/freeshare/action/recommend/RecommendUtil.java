...
public class RecommendUtil {
	...
	public static void postLog(Integer uid, Integer itemId,
			String behaviorType, ResourceWrapper adapter) {
		try {
	...
	private static void postLog(Long uid, Long itemId, String behaviorType,
			ResourceWrapper adapter) throws HttpException, IOException,
			JSONException {
	...
	private static void log(Long uid, Long itemId, String behaviorType)
