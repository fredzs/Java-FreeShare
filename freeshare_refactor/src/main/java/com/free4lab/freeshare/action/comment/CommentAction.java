			...
			if (!authorId.equals(loginId) && parentId == null) {
				...
				if (type == 0) {
					content = toName + "，您好！<br/><br/>" + "您发布的资源\"" + name + "\"被 " + uname + " 评论。您可以点击"
							+ "<a href = \"http://freeshare.free4lab.com/resource?id=" + id + "\">"
							+ "http://freeshare.free4lab.com/resource?id=" + id + "</a>" + "进行相关处理。<br/><br/><br/><br/>"
					...
					try {
						...
						//发送消息提醒
						redirectUrl = "http://freeshare.free4lab.com/resource?id="+id;						
						toUserId.add(aid);
