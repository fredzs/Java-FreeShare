...
import com.free4lab.freeshare.action.group.DeleteGroup;
 ...
 * 
 */
public class ResourceRatingAction extends BaseAction {
    ...
    public String execute() {
        ScoreManagerFactory.getScoreManager(resourceType).addUpDown(id, getSessionUID(), upDown);
        if (upDown.equals("up")) {
    ...
    public static void main(String[] args){
        ResourceRatingAction rra = new ResourceRatingAction();
