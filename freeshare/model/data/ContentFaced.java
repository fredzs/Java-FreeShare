...
public class ContentFaced {
	...
	public static void main(String[] args) throws JSONException{
		BasicContent bcontent = new BasicContent(1, "123", 1, 2);
		VideoContent vcontent = new VideoContent("imgUrl", "srcUrl", "swfUrl", "videoImgUrl");
		System.out.println(getContent(bcontent, vcontent));
	}
}
