	...
	public String execute() throws Exception{
		...
		{				
			for(int i=0; i<toUserNameToIds.size(); i++){
				...
				description = description.replace(nameToIdItem, nameToIds[0]);
		...
		if( ("success").equals(returnStatus) ){
			...
			logger.info("http://freeshare.free4lab.com/item_id="+id);
			String redirectUrl = "http://freeshare.free4lab.com/item?id="+id;
